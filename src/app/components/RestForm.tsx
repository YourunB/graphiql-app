...
export default function RestForm() {
  ...
  const loadDataFromApi = async () => {
    const data = await getDataRestApi(inputRef.current.value, queryValue, variablesValue, headersValue);
  ...
  return (
    <div className={s['rest-form']}>
      <div className={s.top}>
        <input className={s['top__input']} defaultValue={'https://rickandmortyapi.com/api/character'} ref={inputRef} placeholder='Base URL...'/>
